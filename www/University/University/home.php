...
<head>
    <meta charset="UTF-8">
    <link rel="shortcuticon" type="Icon" >
...
<header>
    ...
    <span class="hamburger-btn material-symbols-rounded">menu</span> 
        ...
        <button class="login-btn" style=" color:black;background-color:#AB5F13">LOG IN</button>
    </nav>
    <h2 class="h1">WELCOME TO CSBT CAMPUS  <br><br>Start your Life</h2>

...
<header>
    <nav class="navbar">
       ...
       <ul class="links">
        ...
        <li style><a href="university.php" class="login-btn" style="color: black; background-color:#258303">Home</a></li>
        <li><a href="student.php" class="login-btn" style="color: black;background-color:#9B0010">Student</a></li>
        ...
        <div class="form-content">
            ...
            <form method="POST" action="update.php">
                ...
                <div class="button-group">
                    ...
                    <button type="submit" name="delete" onclick="return confirm('Are you sure you want to delete this student?')"  style="background-color:#940808">Delete</button>
                    <button type="submit" name="delete" onclick="window.location.href='student.php';" style="background-color:#5B0606">Exit</button>
                </div>
            </form>
        </div>
    </div>
